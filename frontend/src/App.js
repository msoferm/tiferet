...
const PAGES = { dashboard: Dashboard, members: Members, donors: Donors, donations: Donations, campaigns: Campaigns, events: Events, reminders: Reminders, expenses: Expenses };
